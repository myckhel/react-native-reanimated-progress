...
import type { PieProgressProps } from './type';
import {
  DEFAULT_BG_COLOR,
  DEFAULT_FILL_COLOR,
  DEFAULT_RADIUS,
...
import { toRad } from 'react-native-redash/lib/module/v1';
...
const PieComponent = ({
  ...
  const d = concat(
    `M${radius},${radius} L0,${radius} A${radius},${radius} 0 `,
    largeArc,
    ' 1 ',
    x,
    ',',
  ...
  const border = useMemo(
    ...
    [strokeWidth, radius, strokeColor]
  );
  const svgStyle = [
    border,
    {
...
export default memo(PieComponent, (prevProps, nextProps) =>
